...
public class IntTest {
     ...
     */
    private static final int testvar1 = (int) (Math.random() * 100); //zufallszahl
    private static final int testvar2 = (int) (Math.random() * 100); //zufallszahl
    private static final short fixvar1 = 8; //fixwert
    private static final double fixvar2 = 12;//fixwert
